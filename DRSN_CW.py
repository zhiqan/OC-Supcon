...
class RSNet(nn.Module):
    ...
    def __init__(self, block, num_block,num_classes):
        ...
        self.head = nn.Sequential(nn.Linear(512 * block.expansion,512 * block.expansion), nn.BatchNorm1d(512 * block.expansion), nn.ReLU(inplace=True),
                                   nn.Linear(512 * block.expansion, int(0.25*512 * block.expansion)))
        self.head_fc = nn.Sequential(nn.Linear(512 * block.expansion,512 * block.expansion), nn.BatchNorm1d(512 * block.expansion), nn.ReLU(inplace=True),
                                   nn.Linear(512 * block.expansion, int(0.25*512 * block.expansion)))
